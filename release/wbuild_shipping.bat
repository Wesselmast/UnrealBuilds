...
call RunUAT BuildCookRun -project=%secnd%  -noP4 -platform=Win64 -clientconfig=Shipping -serverconfig=Shipping -cook -maps=AllMaps -compile -stage -pak -archive -archivedirectory=%third%
popd
exit(1)